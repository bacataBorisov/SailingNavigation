...
class NMEAReader: NSObject, GCDAsyncUdpSocketDelegate, GCDAsyncSocketDelegate {
    ...
    //these two haven't been used yet, I need to find a proper place for them
                    ...
                    if sentenceFormat {
                        ...
                        case "HDG":
                            ...
                            if  let unwrappedHeading = magneticHeading,
                                ...
                                //TODO: - write the function for rotating the compass ring
                                ...
                                if let unwrappedHDG = magneticHeading {
                                    ...
                                    if magneticArray.count > 1 {
                                        ...
                                        //function to normalize the angle for display and other calculations - pass newAngle values as a variable because the other is
                        ...
                        case "VLW":
                            ...
                            /* This will not make difference between different GPS sentences. I am not sure yet, how to handle that.
                             Does it make any difference? Probably. I need to find a way do distinguish a way of differentiating between differetn GPSs - maybe in the later uogrades */
                                    ...
                                    if let unwrappedMarkerCoordinate = markerCoordinate {
                                        ...
                                        if let unwrappedLat = boatLocation?.latitude,
                                           ...
                                           let unwrappedBoatLocation = boatLocation {
                                            ...
                                            print("BEARING TO THE MARK IS: \(String(describing: markBearing))")
    ...
    func trueWindForceConvert(windAngle: Double,appWindForce: Double, heading: Double, boatSpeed: Double) -> Double {
        ...
        //I will be using SOG for now. I am not sure which one is better. To be discusses
    ...
    //TODO: - Write an unwrapping function for the values to be returned in the Mapview and in Settings
